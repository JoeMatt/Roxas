...
#if TARGET_OS_TV
- (instancetype)initWithItems:(NSArray<ContentType> *)items searchResultsController:(nonnull UIViewController*)searchResultsController NS_DESIGNATED_INITIALIZER;
#else
